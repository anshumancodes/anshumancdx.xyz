...
const Home = ({ isDarkMode, toggleMode }) => {
  ...
  return (
    ...
    >
      <section className="flex items-center flex-col px-0 py-11 mt-10up justify-center">
        <h1 className="text-3xl font-bold text-center text-[#f5f5f5] text-[38px] lg:text-[62px]">
          Hey! its Anshuman
        </h1>
        <p className="lg:text-sm text-gray-500 flex gap-1 flex-row items-center mt-12">
          <div className="bg-[#6BFF11] w-[4px] h-[4px] rounded-[50%]"></div>
          available for small and medium projects
        </p>
        <p className="text-xl text-gray-500 mt-4 text-left w-80c lg:w-[480px]">
          am a computer science student and full-stack developer , looking to
          work as a freelance developer.
        </p>
        <a href="">
          <button className="bg-inherit px-7 py-2 rounded-md border-[#f5f5f5] border-[2px] mt-5">
            Say Hello!
          </button>
        </a>
      </section>
