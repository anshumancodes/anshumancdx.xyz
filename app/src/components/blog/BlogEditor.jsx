...
const BlogEditor = () => {
  ...
  return (
    <div>
      ...
      <input type="text" placeholder="  write slug" className=" ml-[42px] mt-5 mb-5 py-2 px-5 min-w-[795px] max-w-[795px] border border-slate-400 outline-none"/>
        <div
        ...
        <span><button className="px-4 py-2 bg-green-500 ml-[42px] mt-5">Create blog</button></span>
      </div>
